...
pub struct WriteSetChangeWriteResource {
    ...
    #[serde(rename = "data")]
    pub data: Box<models::MoveResource>,
    #[serde(rename = "type")]
    pub r#type: Type,
}

impl WriteSetChangeWriteResource {
    pub fn new(address: String, state_key_hash: String, data: models::MoveResource, r#type: Type) -> WriteSetChangeWriteResource {
