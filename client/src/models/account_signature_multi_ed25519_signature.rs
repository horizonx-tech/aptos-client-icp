...
pub struct AccountSignatureMultiEd25519Signature {
...
impl AccountSignatureMultiEd25519Signature {
    pub fn new(public_keys: Vec<String>, signatures: Vec<String>, threshold: i32, bitmap: String, r#type: Type) -> AccountSignatureMultiEd25519Signature {
