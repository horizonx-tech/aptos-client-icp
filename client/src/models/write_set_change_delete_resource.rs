...
pub struct WriteSetChangeDeleteResource {
...
impl WriteSetChangeDeleteResource {
    pub fn new(address: String, state_key_hash: String, resource: String, r#type: Type) -> WriteSetChangeDeleteResource {
