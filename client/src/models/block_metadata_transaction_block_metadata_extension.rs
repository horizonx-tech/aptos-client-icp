...
pub struct BlockMetadataTransactionBlockMetadataExtension {
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl BlockMetadataTransactionBlockMetadataExtension {
    pub fn new(r#type: Type) -> BlockMetadataTransactionBlockMetadataExtension {
