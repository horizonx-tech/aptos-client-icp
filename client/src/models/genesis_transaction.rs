...
/// GenesisTransaction : The genesis transaction  This only occurs at the genesis transaction (version 0)
...
impl GenesisTransaction {
    ...
    pub fn new(version: String, hash: String, state_change_hash: String, event_root_hash: String, gas_used: String, success: bool, vm_status: String, accumulator_root_hash: String, changes: Vec<models::WriteSetChange>, payload: models::GenesisPayload, events: Vec<models::Event>) -> GenesisTransaction {
        GenesisTransaction {
            version,
            hash,
            state_change_hash,
