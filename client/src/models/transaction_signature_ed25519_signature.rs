...
pub struct TransactionSignatureEd25519Signature {
...
impl TransactionSignatureEd25519Signature {
    pub fn new(public_key: String, signature: String, r#type: Type) -> TransactionSignatureEd25519Signature {
